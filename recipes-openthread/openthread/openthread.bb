...
OT_SRC_REV_OPTS_PATCHES_INCLUDE="${@bb.utils.contains_any('MACHINE', "imx8mmevk-matter imx93evk-matter imx6ullevk imx8ulpevk", 'ot_src_rev_opts_patches_standard.inc', 'iw612_ot_src_rev_opts_patches.inc', d)}"
