...
Change the current directory to the top directory of the Yocto source code and execute the command below:
    ...
    # For i.MX8M Mini EVK which use IW612 chipset:
...
- ${MY_YOCTO}/bld-xwayland-imx8mm-iw612/tmp/deploy/images/imx8mmevk-iw612-matter/imx-image-multimedia-imx8mmevk-iw612-matter.wic.zst for i.MX8M Mini EVK which use IW612 chipset.
